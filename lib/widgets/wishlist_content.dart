      ...
      slivers: [
        SliverGrid(
          ...
          delegate:
            ...
            if (index >= wishedItems.lovedItems.length) {
              log(wishedItems.lovedItems.length.toString());
              return null;
            }

            return Consumer<WishListProvider>(
                builder: (context, usedProvider, child) {
              final Product data = usedProvider.lovedItems[index];
              return Container(
                              ...
                              children: [
                                ...
                                IconButton(
                                  onPressed: () async {
                                    ...
                                    wishedItems.fetchWishedItems(context);
                                  },
